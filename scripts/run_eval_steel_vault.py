#!/usr/bin/env python3
"""Run 50-question benchmark against the steel_vault PDF."""
...
from evaluation_questions import QUESTIONS_STEEL_VAULT as QUESTIONS

PDF = Path("/Users/jonathang/Downloads/SteelVaultCorp_20081224_10-K_EX-10.16_3074935_EX-10.16_Affiliate Agreement.pdf")
OUT = ROOT / "scripts" / "steel_vault_eval_result.json"
